...
# def update_report_category(report, category_id:str, revenue:float):
#     for category in report['categories']:
#         if category["id"] == category_id:
#             category['revenue']+= revenue


# def update_report_configuration(report : Dict[str, List[Dict]], configuration_id:str, revenue:float):
#     for configuration in report['configurations']:
#         if configuration["id"] == configuration_id:
#             configuration['revenue']+= revenue
